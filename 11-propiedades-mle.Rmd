...
- Referencias para hacer ejercicios.
  - ...
...
<!-- - No se deben considerar como estimadores puntuales. -->
...
<!-- - Cuando se cumple esta regla, el estimador es consistente. -->
...
<!-- - En la tarea 9 vimos que el cociente es el valor de máxima verosimilitud. -->
...
<!-- - Este método es solo aproximación. Puede ser tan preciso como bootstrap. -->
...
<!-- - La media es un estimador más eficiente porque usa más datos que la mediana. -->
