...
denotado por $\hat \theta,$ o $\theta_N.$
```
...
de una muestra aleatoria ($T(X),$ para $X_n \sim \pi_x$ para $n = 1, \ldots, N$), es por consiguiente aleatoria y es por tanto una
...
$\bar{X}=\frac1N\sum_n X_n$ es una estadística.
=======
Comencemos recordando la definición de parámetro y estadística. 
