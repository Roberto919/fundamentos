...
```
<!-- - Aquí no vemos mucha dependencia entre mu y sigma. -->
...
<!-- - Una de las herramientas más comunes es hacer gráficas cuantiles-cuantiles. -->
<!--   - Podemos ver en qué son distintas. -->
...
<!-- - Esta gráfica nos enseña que hay un desajuste. La cola es considerablemente más larga que la exponencial. -->
...
<!-- - La gamma nos muestra que tiene un mejor ajuste. -->
...
g_1 + g_2
```
<!-- - Con esto evaluamos qué tan bueno es nuestro modelo. Vemos que no está mal. -->
...
estimación?
  <!-- - Sí, hace sentido porque tenemos un modelo más parsimonioso. -->
- ¿Qué pasa si intentas ajustar un modelo normal a estos datos?
  <!-- - Al hacer ejercicio de ajustar una normal vemos que el ajuste no es tan tan bueno. -->
```
...
<!-- - En este caso no es fácil diferenciar entre los dos casos. -->
<!-- - Nótese que estamos usando la función logit para desacotar el problema. Después estamos aplicando el inverso para regresar los valores originales. -->
...
<!-- - Nuestras estimaciones son menos precisas. -->
<!-- - Con bootstrap vamos a corroborar. -->
...
```
<!-- - Vemos que las variables están muy correlacionadas. -->
<!-- - La probabilidad de azar tiene un rango muy muy grande. -->
<!-- - Es muy difícil estimar los parámetros y contestar bien. -->
...
<!-- - En estos casos podemos usar estadística Bayesiana para mejorar la estimación. -->
