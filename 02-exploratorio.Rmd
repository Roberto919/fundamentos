...
Empezamos explicando algunas ideas que nos serán útiles más adelante.
...
bind_rows(head(cuenta), tail(cuenta)) %>% knitr::kable(digits = 3)
```
...
<div style= "float:right;padding=10px; top:-10px; width:40%">

![Imagen [Jumanbar / CC BY-SA](https://creativecommons.org/licenses/by-sa/3.0)](images/boxplot.png)
...
junto con análisis de serie de tiempo de @cleveland93
...
En este caso particular, construiremos una **descomposición aditiva** de la serie de tiempo (@cleveland93).
