...
<!-- - En este caso el estimador plug-in sería tomar la proporción de registros en esta muesta (2/8) -->
...
ggplot(dat_verosim, aes(x = x, y = prob)) + geom_line() +
  ...
  xlab("p")
```
<!-- - En este caso coincide el resultado bootstrap con máxima verosimilitud pero esto no se va a cumplir siempre. -->
<!-- - Esta curva nos explica cuáles son los valores más verosímiles. -->
...
```
<!-- - Los parámetros no pueden tomar cualquier valor, están restringidos al problema particular. -->
...
```
<!-- - Media: los reales -->
<!-- - Varianza: los positivos -->
<!-- - N: los naturales hasta el infinito -->
<!-- - p: 0 a 1 -->
...
<!-- - Hay que recordar que theta puede ser muy complicada, puedes ser: -->
<!--   - "p" -->
<!--   - "lambda" -->
<!--   - un vector -->
...
```
<!-- - El resultado es la media y la varianza -->
...
# Por default optim minimiza. Lo de control es para maximizar.
```
...
<!-- - Para poder determinar la probabilidad, tenemos que usar la "probabilidad total" -->
